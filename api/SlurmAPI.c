...
// Functions for enum  for SlurmAPI_slurmctldCancelJob

static char* slurmctldCancelJob__ToString(slurm_rest_api_slurmctldCancelJob_signal_e ){
    char *Array[] =  { "NULL", "HUP", "INT", "QUIT", "ABRT", "KILL", "ALRM", "TERM", "USR1", "USR2", "URG", "CONT", "STOP", "TSTP", "TTIN", "TTOU" };
    return Array[];
}

static slurm_rest_api_slurmctldCancelJob_signal_e slurmctldCancelJob__FromString(char* ){
...
/*
// Function slurmctldCancelJob__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *slurmctldCancelJob__convertToJSON(slurm_rest_api_slurmctldCancelJob_signal_e ) {
...
// Function slurmctldCancelJob__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static slurm_rest_api_slurmctldCancelJob_signal_e slurmctldCancelJob__parseFromJSON(cJSON* JSON) {
    slurm_rest_api_slurmctldCancelJob_signal_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
SlurmAPI_slurmctldCancelJob(apiClient_t *apiClient, char * job_id , v0_0_37_signal_e signal )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/job/{job_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/job/{job_id}");
    ...
    v0_0_37_signal_e valueQuery_signal ;
    keyValuePair_t *keyPairQuery_signal = 0;
    if (signal)
    {
        keyQuery_signal = strdup("signal");
        valueQuery_signal = (signal);
        keyPairQuery_signal = keyValuePair_create(keyQuery_signal, (void *)strdup(slurmctldCancelJob__ToString(
		&valueQuery_signal)));
...
SlurmAPI_slurmctldDiag(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/diag")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/diag");
    ...
    v0_0_37_diag_t *elementToReturn = v0_0_37_diag_parseFromJSON(SlurmAPIlocalVarJSON);
...
SlurmAPI_slurmctldGetJob(apiClient_t *apiClient, char * job_id )
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v0_0_37_jobs_response_t *elementToReturn = v0_0_37_jobs_response_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmctldGetJobs(apiClient_t *apiClient, long update_time )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/jobs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/jobs");
...
SlurmAPI_slurmctldGetNode(apiClient_t *apiClient, char * node_name )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/node/{node_name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/node/{node_name}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v0_0_37_nodes_response_t *elementToReturn = v0_0_37_nodes_response_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmctldGetNodes(apiClient_t *apiClient, long update_time )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/nodes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/nodes");
...
SlurmAPI_slurmctldGetPartition(apiClient_t *apiClient, char * partition_name , long update_time )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/partition/{partition_name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/partition/{partition_name}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v0_0_37_partitions_response_t *elementToReturn = v0_0_37_partitions_response_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmctldGetPartitions(apiClient_t *apiClient, long update_time )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/partitions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/partitions");
...
SlurmAPI_slurmctldGetReservation(apiClient_t *apiClient, char * reservation_name , long update_time )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/reservation/{reservation_name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/reservation/{reservation_name}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v0_0_37_reservations_response_t *elementToReturn = v0_0_37_reservations_response_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmctldGetReservations(apiClient_t *apiClient, long update_time )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/reservations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/reservations");
...
SlurmAPI_slurmctldPing(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/ping")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/ping");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v0_0_37_pings_t *elementToReturn = v0_0_37_pings_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmctldSubmitJob(apiClient_t *apiClient, v0_0_37_job_submission_t * v0_0_37_job_submission )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurm/v0.0.37/job/submit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurm/v0.0.37/job/submit");




    // Body Param
    cJSON *localVarSingleItemJSON_v0_0_37_job_submission = NULL;
    if (v0_0_37_job_submission != NULL)
    {
        //string
        localVarSingleItemJSON_v0_0_37_job_submission = v0_0_37_job_submission_convertToJSON(v0_0_37_job_submission);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_v0_0_37_job_submission);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/x-yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v0_0_37_job_submission_response_t *elementToReturn = v0_0_37_job_submission_response_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_v0_0_37_job_submission) {
        cJSON_Delete(localVarSingleItemJSON_v0_0_37_job_submission);
        localVarSingleItemJSON_v0_0_37_job_submission = NULL;
    }
...
SlurmAPI_slurmctldUpdateJob(apiClient_t *apiClient, char * job_id , v0_0_37_job_properties_t * v0_0_37_job_properties )
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_v0_0_37_job_properties = NULL;
    if (v0_0_37_job_properties != NULL)
    {
        //string
        localVarSingleItemJSON_v0_0_37_job_properties = v0_0_37_job_properties_convertToJSON(v0_0_37_job_properties);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_v0_0_37_job_properties);
    }
    list_addElement(localVarContentType,"application/json"); //consumes
    list_addElement(localVarContentType,"application/x-yaml"); //consumes
    apiClient_invoke(apiClient,
    ...
    free(localVarPath);
    free(localVarToReplace_job_id);
    if (localVarSingleItemJSON_v0_0_37_job_properties) {
        cJSON_Delete(localVarSingleItemJSON_v0_0_37_job_properties);
        localVarSingleItemJSON_v0_0_37_job_properties = NULL;
    }
    free(localVarBodyParameters);
...
SlurmAPI_slurmdbdAddClusters(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/clusters")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/clusters");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_cluster_add_t *elementToReturn = dbv0_0_37_response_cluster_add_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdAddWckeys(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/wckeys")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/wckeys");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_wckey_add_t *elementToReturn = dbv0_0_37_response_wckey_add_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdDeleteAccount(apiClient_t *apiClient, char * account_name )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/account/{account_name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/account/{account_name}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_account_delete_t *elementToReturn = dbv0_0_37_response_account_delete_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdDeleteAssociation(apiClient_t *apiClient, char * account , char * user , char * cluster , char * partition )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/association")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/association");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_association_delete_t *elementToReturn = dbv0_0_37_response_association_delete_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdDeleteCluster(apiClient_t *apiClient, char * cluster_name )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/cluster/{cluster_name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/cluster/{cluster_name}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_cluster_delete_t *elementToReturn = dbv0_0_37_response_cluster_delete_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdDeleteQos(apiClient_t *apiClient, char * qos_name )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/qos/{qos_name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/qos/{qos_name}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_qos_delete_t *elementToReturn = dbv0_0_37_response_qos_delete_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdDeleteUser(apiClient_t *apiClient, char * user_name )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/user/{user_name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/user/{user_name}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_user_delete_t *elementToReturn = dbv0_0_37_response_user_delete_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdDeleteWckey(apiClient_t *apiClient, char * wckey )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/wckey/{wckey}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/wckey/{wckey}");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_wckey_delete_t *elementToReturn = dbv0_0_37_response_wckey_delete_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdDiag(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/diag")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/diag");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_diag_t *elementToReturn = dbv0_0_37_diag_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetAccount(apiClient_t *apiClient, char * account_name )
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_account_info_t *elementToReturn = dbv0_0_37_account_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetAccounts(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/accounts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/accounts");
...
SlurmAPI_slurmdbdGetAssociation(apiClient_t *apiClient, char * cluster , char * account , char * user , char * partition )
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_associations_info_t *elementToReturn = dbv0_0_37_associations_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetAssociations(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/associations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/associations");
...
SlurmAPI_slurmdbdGetCluster(apiClient_t *apiClient, char * cluster_name )
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_cluster_info_t *elementToReturn = dbv0_0_37_cluster_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetDbConfig(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/config")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/config");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_config_info_t *elementToReturn = dbv0_0_37_config_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetJob(apiClient_t *apiClient, long job_id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/job/{job_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/job/{job_id}");


    // Path Params
    long sizeOfPathParams_job_id = sizeof(job_id)+3 + strlen("{ job_id }");
    if(job_id == 0){
        goto end;
    }
    char* localVarToReplace_job_id = malloc(sizeOfPathParams_job_id);
    ...
    intToStr(localVarBuff_job_id, job_id);
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_job_info_t *elementToReturn = dbv0_0_37_job_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetJobs(apiClient_t *apiClient, char * submit_time , char * start_time , char * end_time , char * account , char * association , char * cluster , char * constraints , char * cpus_max , char * cpus_min , int skip_steps , int disable_wait_for_result , char * exit_code , char * format , char * group , char * job_name , char * nodes_max , char * nodes_min , char * partition , char * qos , char * reason , char * reservation , char * state , char * step , char * node , char * wckey )
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/jobs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/jobs");
...
SlurmAPI_slurmdbdGetQos(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/qos")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/qos");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_qos_info_t *elementToReturn = dbv0_0_37_qos_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetTres(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/tres")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/tres");
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_tres_info_t *elementToReturn = dbv0_0_37_tres_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetUser(apiClient_t *apiClient, char * user_name )
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_user_info_t *elementToReturn = dbv0_0_37_user_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdGetUsers(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/slurmdb/v0.0.37/users")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/slurmdb/v0.0.37/users");
...
SlurmAPI_slurmdbdGetWckey(apiClient_t *apiClient, char * wckey )
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_wckey_info_t *elementToReturn = dbv0_0_37_wckey_info_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdSetDbConfig(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_config_response_t *elementToReturn = dbv0_0_37_config_response_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdUpdateAccount(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_account_response_t *elementToReturn = dbv0_0_37_account_response_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdUpdateAssociations(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_associations_t *elementToReturn = dbv0_0_37_response_associations_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdUpdateTres(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_tres_t *elementToReturn = dbv0_0_37_response_tres_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SlurmAPI_slurmdbdUpdateUsers(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *SlurmAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    dbv0_0_37_response_user_update_t *elementToReturn = dbv0_0_37_response_user_update_parseFromJSON(SlurmAPIlocalVarJSON);
    cJSON_Delete(SlurmAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
