...
#include <string.h>
#include <stdio.h>
#include "dbv0_0_38_set_config.h"
...
dbv0_0_38_set_config_t *dbv0_0_38_set_config_create(
    ...
    dbv0_0_38_set_config_t *dbv0_0_38_set_config_local_var = malloc(sizeof(dbv0_0_38_set_config_t));
    if (!dbv0_0_38_set_config_local_var) {
        return NULL;
    }
    dbv0_0_38_set_config_local_var->clusters = clusters;
    dbv0_0_38_set_config_local_var->tres = tres;
    dbv0_0_38_set_config_local_var->accounts = accounts;
    dbv0_0_38_set_config_local_var->users = users;
    dbv0_0_38_set_config_local_var->qos = qos;
    dbv0_0_38_set_config_local_var->wckeys = wckeys;
    dbv0_0_38_set_config_local_var->associations = associations;

    return dbv0_0_38_set_config_local_var;
}


void dbv0_0_38_set_config_free(dbv0_0_38_set_config_t *dbv0_0_38_set_config) {
    if(NULL == dbv0_0_38_set_config){
        return ;
    }
    listEntry_t *listEntry;
    if (dbv0_0_38_set_config->clusters) {
        list_ForEach(listEntry, dbv0_0_38_set_config->clusters) {
            dbv0_0_38_clusters_properties_free(listEntry->data);
        }
        list_freeList(dbv0_0_38_set_config->clusters);
        dbv0_0_38_set_config->clusters = NULL;
    }
    if (dbv0_0_38_set_config->tres) {
        list_ForEach(listEntry, dbv0_0_38_set_config->tres) {
            free(listEntry->data);
        }
        list_freeList(dbv0_0_38_set_config->tres);
        dbv0_0_38_set_config->tres = NULL;
    }
    if (dbv0_0_38_set_config->accounts) {
        list_ForEach(listEntry, dbv0_0_38_set_config->accounts) {
            dbv0_0_38_update_account_free(listEntry->data);
        }
        list_freeList(dbv0_0_38_set_config->accounts);
        dbv0_0_38_set_config->accounts = NULL;
    }
    if (dbv0_0_38_set_config->users) {
        list_ForEach(listEntry, dbv0_0_38_set_config->users) {
            dbv0_0_38_user_free(listEntry->data);
        }
        list_freeList(dbv0_0_38_set_config->users);
        dbv0_0_38_set_config->users = NULL;
    }
    if (dbv0_0_38_set_config->qos) {
        list_ForEach(listEntry, dbv0_0_38_set_config->qos) {
            dbv0_0_38_qos_free(listEntry->data);
        }
        list_freeList(dbv0_0_38_set_config->qos);
        dbv0_0_38_set_config->qos = NULL;
    }
    if (dbv0_0_38_set_config->wckeys) {
        list_ForEach(listEntry, dbv0_0_38_set_config->wckeys) {
            dbv0_0_38_wckey_free(listEntry->data);
        }
        list_freeList(dbv0_0_38_set_config->wckeys);
        dbv0_0_38_set_config->wckeys = NULL;
    }
    if (dbv0_0_38_set_config->associations) {
        list_ForEach(listEntry, dbv0_0_38_set_config->associations) {
            dbv0_0_38_association_free(listEntry->data);
        }
        list_freeList(dbv0_0_38_set_config->associations);
        dbv0_0_38_set_config->associations = NULL;
    }
    free(dbv0_0_38_set_config);
}

cJSON *dbv0_0_38_set_config_convertToJSON(dbv0_0_38_set_config_t *dbv0_0_38_set_config) {
    cJSON *item = cJSON_CreateObject();

    // dbv0_0_38_set_config->clusters
    if(dbv0_0_38_set_config->clusters) {
    ...
    if (dbv0_0_38_set_config->clusters) {
    list_ForEach(clustersListEntry, dbv0_0_38_set_config->clusters) {
    cJSON *itemLocal = dbv0_0_38_clusters_properties_convertToJSON(clustersListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    list_ForEach(tresListEntry, dbv0_0_38_set_config->tres) {
    }
    }


    // dbv0_0_38_set_config->accounts
    if(dbv0_0_38_set_config->accounts) {
    ...
    if (dbv0_0_38_set_config->accounts) {
    list_ForEach(accountsListEntry, dbv0_0_38_set_config->accounts) {
    cJSON *itemLocal = dbv0_0_38_update_account_convertToJSON(accountsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if (dbv0_0_38_set_config->users) {
    list_ForEach(usersListEntry, dbv0_0_38_set_config->users) {
    ...
    if (dbv0_0_38_set_config->qos) {
    list_ForEach(qosListEntry, dbv0_0_38_set_config->qos) {
    ...
    if (dbv0_0_38_set_config->wckeys) {
    list_ForEach(wckeysListEntry, dbv0_0_38_set_config->wckeys) {
    ...
    // dbv0_0_38_set_config->associations
    if(dbv0_0_38_set_config->associations) {
    ...
    if (dbv0_0_38_set_config->associations) {
    list_ForEach(associationsListEntry, dbv0_0_38_set_config->associations) {
...
dbv0_0_38_set_config_t *dbv0_0_38_set_config_parseFromJSON(cJSON *dbv0_0_38_set_configJSON){
    ...
    dbv0_0_38_set_config_t *dbv0_0_38_set_config_local_var = NULL;

    // define the local list for dbv0_0_38_set_config->clusters
    list_t *clustersList = NULL;

    // define the local list for dbv0_0_38_set_config->tres
    list_t *tresList = NULL;

    // define the local list for dbv0_0_38_set_config->accounts
    list_t *accountsList = NULL;

    // define the local list for dbv0_0_38_set_config->users
    list_t *usersList = NULL;

    // define the local list for dbv0_0_38_set_config->qos
    list_t *qosList = NULL;

    // define the local list for dbv0_0_38_set_config->wckeys
    list_t *wckeysList = NULL;

    // define the local list for dbv0_0_38_set_config->associations
    list_t *associationsList = NULL;

    // dbv0_0_38_set_config->clusters
    cJSON *clusters = cJSON_GetObjectItemCaseSensitive(dbv0_0_38_set_configJSON, "clusters");
    if (clusters) { 
    ...
    cJSON_ArrayForEach(clusters_local_nonprimitive,clusters )
    {
        ...
        dbv0_0_38_clusters_properties_t *clustersItem = dbv0_0_38_clusters_properties_parseFromJSON(clusters_local_nonprimitive);
    ...
    // dbv0_0_38_set_config->tres
    cJSON *tres = cJSON_GetObjectItemCaseSensitive(dbv0_0_38_set_configJSON, "TRES");
    if (tres) { 
    ...
    // dbv0_0_38_set_config->accounts
    cJSON *accounts = cJSON_GetObjectItemCaseSensitive(dbv0_0_38_set_configJSON, "accounts");
    if (accounts) { 
    ...
    cJSON_ArrayForEach(accounts_local_nonprimitive,accounts )
    {
        ...
        dbv0_0_38_update_account_t *accountsItem = dbv0_0_38_update_account_parseFromJSON(accounts_local_nonprimitive);
    ...
    // dbv0_0_38_set_config->users
    cJSON *users = cJSON_GetObjectItemCaseSensitive(dbv0_0_38_set_configJSON, "users");
    if (users) { 
    ...
    // dbv0_0_38_set_config->qos
    cJSON *qos = cJSON_GetObjectItemCaseSensitive(dbv0_0_38_set_configJSON, "qos");
    if (qos) { 
    ...
    // dbv0_0_38_set_config->wckeys
    cJSON *wckeys = cJSON_GetObjectItemCaseSensitive(dbv0_0_38_set_configJSON, "wckeys");
    if (wckeys) { 
    ...
    // dbv0_0_38_set_config->associations
    cJSON *associations = cJSON_GetObjectItemCaseSensitive(dbv0_0_38_set_configJSON, "associations");
    if (associations) { 
    ...
    dbv0_0_38_set_config_local_var = dbv0_0_38_set_config_create (
