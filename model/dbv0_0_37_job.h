...
#ifndef _dbv0_0_37_job_H_
#define _dbv0_0_37_job_H_
...
typedef struct dbv0_0_37_job_t dbv0_0_37_job_t;
...
typedef struct dbv0_0_37_job_t {
    char *account; // string
    struct dbv0_0_37_job_comment_t *comment; //model
    char *allocation_nodes; // string
    struct dbv0_0_37_job_array_t *array; //model
    struct dbv0_0_37_job_time_t *time; //model
    struct dbv0_0_37_association_short_info_t *association; //model
    char *cluster; // string
    char *constraints; // string
    struct dbv0_0_37_job_exit_code_t *derived_exit_code; //model
    struct dbv0_0_37_job_exit_code_t *exit_code; //model
    list_t *flags; //primitive container
    char *group; // string
    struct dbv0_0_37_job_het_t *het; //model
    int job_id; //numeric
    char *name; // string
    struct dbv0_0_37_job_mcs_t *mcs; //model
    char *nodes; // string
    char *partition; // string
    int priority; //numeric
    char *qos; // string
    struct dbv0_0_37_job_required_t *required; //model
    char *kill_request_user; // string
    struct dbv0_0_37_job_reservation_t *reservation; //model
    struct dbv0_0_37_job_state_t *state; //model
    list_t *steps; //nonprimitive container
    struct dbv0_0_37_job_tres_t *tres; //model
    char *user; // string
    struct dbv0_0_37_job_wckey_t *wckey; //model
