...
#include <string.h>
#include <stdio.h>
#include "dbv0_0_37_config_info.h"
...
dbv0_0_37_config_info_t *dbv0_0_37_config_info_create(
    ...
    dbv0_0_37_config_info_t *dbv0_0_37_config_info_local_var = malloc(sizeof(dbv0_0_37_config_info_t));
    if (!dbv0_0_37_config_info_local_var) {
        return NULL;
    }
    dbv0_0_37_config_info_local_var->errors = errors;
    dbv0_0_37_config_info_local_var->tres = tres;
    dbv0_0_37_config_info_local_var->accounts = accounts;
    dbv0_0_37_config_info_local_var->associations = associations;
    dbv0_0_37_config_info_local_var->users = users;
    dbv0_0_37_config_info_local_var->qos = qos;
    dbv0_0_37_config_info_local_var->wckeys = wckeys;

    return dbv0_0_37_config_info_local_var;
}


void dbv0_0_37_config_info_free(dbv0_0_37_config_info_t *dbv0_0_37_config_info) {
    if(NULL == dbv0_0_37_config_info){
        return ;
    }
    listEntry_t *listEntry;
    if (dbv0_0_37_config_info->errors) {
        list_ForEach(listEntry, dbv0_0_37_config_info->errors) {
            dbv0_0_37_error_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_config_info->errors);
        dbv0_0_37_config_info->errors = NULL;
    }
    if (dbv0_0_37_config_info->tres) {
        list_ForEach(listEntry, dbv0_0_37_config_info->tres) {
            free(listEntry->data);
        }
        list_freeList(dbv0_0_37_config_info->tres);
        dbv0_0_37_config_info->tres = NULL;
    }
    if (dbv0_0_37_config_info->accounts) {
        list_ForEach(listEntry, dbv0_0_37_config_info->accounts) {
            dbv0_0_37_account_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_config_info->accounts);
        dbv0_0_37_config_info->accounts = NULL;
    }
    if (dbv0_0_37_config_info->associations) {
        list_ForEach(listEntry, dbv0_0_37_config_info->associations) {
            dbv0_0_37_association_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_config_info->associations);
        dbv0_0_37_config_info->associations = NULL;
    }
    if (dbv0_0_37_config_info->users) {
        list_ForEach(listEntry, dbv0_0_37_config_info->users) {
            dbv0_0_37_user_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_config_info->users);
        dbv0_0_37_config_info->users = NULL;
    }
    if (dbv0_0_37_config_info->qos) {
        list_ForEach(listEntry, dbv0_0_37_config_info->qos) {
            dbv0_0_37_qos_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_config_info->qos);
        dbv0_0_37_config_info->qos = NULL;
    }
    if (dbv0_0_37_config_info->wckeys) {
        list_ForEach(listEntry, dbv0_0_37_config_info->wckeys) {
            dbv0_0_37_wckey_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_config_info->wckeys);
        dbv0_0_37_config_info->wckeys = NULL;
    }
    free(dbv0_0_37_config_info);
}

cJSON *dbv0_0_37_config_info_convertToJSON(dbv0_0_37_config_info_t *dbv0_0_37_config_info) {
    cJSON *item = cJSON_CreateObject();

    // dbv0_0_37_config_info->errors
    if(dbv0_0_37_config_info->errors) {
    ...
    if (dbv0_0_37_config_info->errors) {
    list_ForEach(errorsListEntry, dbv0_0_37_config_info->errors) {
    ...
    list_ForEach(tresListEntry, dbv0_0_37_config_info->tres) {
    }
    }


    // dbv0_0_37_config_info->accounts
    if(dbv0_0_37_config_info->accounts) {
    ...
    if (dbv0_0_37_config_info->accounts) {
    list_ForEach(accountsListEntry, dbv0_0_37_config_info->accounts) {
    ...
    // dbv0_0_37_config_info->associations
    if(dbv0_0_37_config_info->associations) {
    ...
    if (dbv0_0_37_config_info->associations) {
    list_ForEach(associationsListEntry, dbv0_0_37_config_info->associations) {
    ...
    if (dbv0_0_37_config_info->users) {
    list_ForEach(usersListEntry, dbv0_0_37_config_info->users) {
    cJSON *itemLocal = dbv0_0_37_user_convertToJSON(usersListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if (dbv0_0_37_config_info->qos) {
    list_ForEach(qosListEntry, dbv0_0_37_config_info->qos) {
    ...
    if (dbv0_0_37_config_info->wckeys) {
    list_ForEach(wckeysListEntry, dbv0_0_37_config_info->wckeys) {
...
dbv0_0_37_config_info_t *dbv0_0_37_config_info_parseFromJSON(cJSON *dbv0_0_37_config_infoJSON){
    ...
    dbv0_0_37_config_info_t *dbv0_0_37_config_info_local_var = NULL;

    // define the local list for dbv0_0_37_config_info->errors
    list_t *errorsList = NULL;

    // define the local list for dbv0_0_37_config_info->tres
    list_t *tresList = NULL;

    // define the local list for dbv0_0_37_config_info->accounts
    list_t *accountsList = NULL;

    // define the local list for dbv0_0_37_config_info->associations
    list_t *associationsList = NULL;

    // define the local list for dbv0_0_37_config_info->users
    list_t *usersList = NULL;

    // define the local list for dbv0_0_37_config_info->qos
    list_t *qosList = NULL;

    // define the local list for dbv0_0_37_config_info->wckeys
    list_t *wckeysList = NULL;

    // dbv0_0_37_config_info->errors
    cJSON *errors = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_config_infoJSON, "errors");
    if (errors) { 
    ...
    // dbv0_0_37_config_info->tres
    cJSON *tres = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_config_infoJSON, "tres");
    if (tres) { 
    ...
    // dbv0_0_37_config_info->accounts
    cJSON *accounts = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_config_infoJSON, "accounts");
    if (accounts) { 
    ...
    // dbv0_0_37_config_info->associations
    cJSON *associations = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_config_infoJSON, "associations");
    if (associations) { 
    ...
    // dbv0_0_37_config_info->users
    cJSON *users = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_config_infoJSON, "users");
    if (users) { 
    ...
    cJSON_ArrayForEach(users_local_nonprimitive,users )
    {
        ...
        dbv0_0_37_user_t *usersItem = dbv0_0_37_user_parseFromJSON(users_local_nonprimitive);
    ...
    // dbv0_0_37_config_info->qos
    cJSON *qos = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_config_infoJSON, "qos");
    if (qos) { 
    ...
    // dbv0_0_37_config_info->wckeys
    cJSON *wckeys = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_config_infoJSON, "wckeys");
    if (wckeys) { 
    ...
    dbv0_0_37_config_info_local_var = dbv0_0_37_config_info_create (
