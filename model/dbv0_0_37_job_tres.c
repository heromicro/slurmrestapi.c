...
dbv0_0_37_job_tres_t *dbv0_0_37_job_tres_create(
    ...
    dbv0_0_37_job_tres_t *dbv0_0_37_job_tres_local_var = malloc(sizeof(dbv0_0_37_job_tres_t));
    if (!dbv0_0_37_job_tres_local_var) {
        return NULL;
    }
    dbv0_0_37_job_tres_local_var->allocated = allocated;
    dbv0_0_37_job_tres_local_var->requested = requested;

    return dbv0_0_37_job_tres_local_var;
}


void dbv0_0_37_job_tres_free(dbv0_0_37_job_tres_t *dbv0_0_37_job_tres) {
    if(NULL == dbv0_0_37_job_tres){
        return ;
    }
    listEntry_t *listEntry;
    if (dbv0_0_37_job_tres->allocated) {
        list_ForEach(listEntry, dbv0_0_37_job_tres->allocated) {
            dbv0_0_37_tres_list_inner_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_job_tres->allocated);
        dbv0_0_37_job_tres->allocated = NULL;
    }
    if (dbv0_0_37_job_tres->requested) {
        list_ForEach(listEntry, dbv0_0_37_job_tres->requested) {
            dbv0_0_37_tres_list_inner_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_job_tres->requested);
        dbv0_0_37_job_tres->requested = NULL;
    }
    free(dbv0_0_37_job_tres);
}

cJSON *dbv0_0_37_job_tres_convertToJSON(dbv0_0_37_job_tres_t *dbv0_0_37_job_tres) {
    cJSON *item = cJSON_CreateObject();

    // dbv0_0_37_job_tres->allocated
    if(dbv0_0_37_job_tres->allocated) {
    ...
    if (dbv0_0_37_job_tres->allocated) {
    list_ForEach(allocatedListEntry, dbv0_0_37_job_tres->allocated) {
    ...
    if (dbv0_0_37_job_tres->requested) {
    list_ForEach(requestedListEntry, dbv0_0_37_job_tres->requested) {
    cJSON *itemLocal = dbv0_0_37_tres_list_inner_convertToJSON(requestedListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
dbv0_0_37_job_tres_t *dbv0_0_37_job_tres_parseFromJSON(cJSON *dbv0_0_37_job_tresJSON){
    ...
    dbv0_0_37_job_tres_t *dbv0_0_37_job_tres_local_var = NULL;

    // define the local list for dbv0_0_37_job_tres->allocated
    list_t *allocatedList = NULL;

    // define the local list for dbv0_0_37_job_tres->requested
    list_t *requestedList = NULL;

    // dbv0_0_37_job_tres->allocated
    cJSON *allocated = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_job_tresJSON, "allocated");
    if (allocated) { 
    ...
    // dbv0_0_37_job_tres->requested
    cJSON *requested = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_job_tresJSON, "requested");
    if (requested) { 
    ...
    cJSON_ArrayForEach(requested_local_nonprimitive,requested )
    {
        ...
        dbv0_0_37_tres_list_inner_t *requestedItem = dbv0_0_37_tres_list_inner_parseFromJSON(requested_local_nonprimitive);
    ...
    dbv0_0_37_job_tres_local_var = dbv0_0_37_job_tres_create (
