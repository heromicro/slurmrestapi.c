...
dbv0_0_39_user_info_t *dbv0_0_39_user_info_create(
    ...
    dbv0_0_39_user_info_t *dbv0_0_39_user_info_local_var = malloc(sizeof(dbv0_0_39_user_info_t));
    if (!dbv0_0_39_user_info_local_var) {
        return NULL;
    }
    dbv0_0_39_user_info_local_var->meta = meta;
    dbv0_0_39_user_info_local_var->errors = errors;
    dbv0_0_39_user_info_local_var->warnings = warnings;
    dbv0_0_39_user_info_local_var->users = users;

    return dbv0_0_39_user_info_local_var;
}


void dbv0_0_39_user_info_free(dbv0_0_39_user_info_t *dbv0_0_39_user_info) {
    if(NULL == dbv0_0_39_user_info){
        return ;
    }
    listEntry_t *listEntry;
    if (dbv0_0_39_user_info->meta) {
        dbv0_0_39_meta_free(dbv0_0_39_user_info->meta);
        dbv0_0_39_user_info->meta = NULL;
    }
    if (dbv0_0_39_user_info->errors) {
        list_ForEach(listEntry, dbv0_0_39_user_info->errors) {
            dbv0_0_39_error_free(listEntry->data);
        }
        list_freeList(dbv0_0_39_user_info->errors);
        dbv0_0_39_user_info->errors = NULL;
    }
    if (dbv0_0_39_user_info->warnings) {
        list_ForEach(listEntry, dbv0_0_39_user_info->warnings) {
            dbv0_0_39_warning_free(listEntry->data);
        }
        list_freeList(dbv0_0_39_user_info->warnings);
        dbv0_0_39_user_info->warnings = NULL;
    }
    if (dbv0_0_39_user_info->users) {
        list_ForEach(listEntry, dbv0_0_39_user_info->users) {
            v0_0_39_user_free(listEntry->data);
        }
        list_freeList(dbv0_0_39_user_info->users);
        dbv0_0_39_user_info->users = NULL;
    }
    free(dbv0_0_39_user_info);
}

cJSON *dbv0_0_39_user_info_convertToJSON(dbv0_0_39_user_info_t *dbv0_0_39_user_info) {
    cJSON *item = cJSON_CreateObject();

    // dbv0_0_39_user_info->meta
    if(dbv0_0_39_user_info->meta) {
    cJSON *meta_local_JSON = dbv0_0_39_meta_convertToJSON(dbv0_0_39_user_info->meta);
    ...
    if (dbv0_0_39_user_info->errors) {
    list_ForEach(errorsListEntry, dbv0_0_39_user_info->errors) {
    ...
    if (dbv0_0_39_user_info->warnings) {
    list_ForEach(warningsListEntry, dbv0_0_39_user_info->warnings) {
    ...
    if (dbv0_0_39_user_info->users) {
    list_ForEach(usersListEntry, dbv0_0_39_user_info->users) {
...
dbv0_0_39_user_info_t *dbv0_0_39_user_info_parseFromJSON(cJSON *dbv0_0_39_user_infoJSON){
    ...
    dbv0_0_39_user_info_t *dbv0_0_39_user_info_local_var = NULL;

    // define the local variable for dbv0_0_39_user_info->meta
    dbv0_0_39_meta_t *meta_local_nonprim = NULL;

    // define the local list for dbv0_0_39_user_info->errors
    list_t *errorsList = NULL;

    // define the local list for dbv0_0_39_user_info->warnings
    list_t *warningsList = NULL;

    // define the local list for dbv0_0_39_user_info->users
    list_t *usersList = NULL;

    // dbv0_0_39_user_info->meta
    cJSON *meta = cJSON_GetObjectItemCaseSensitive(dbv0_0_39_user_infoJSON, "meta");
    if (meta) { 
    meta_local_nonprim = dbv0_0_39_meta_parseFromJSON(meta); //nonprimitive
    }

    // dbv0_0_39_user_info->errors
    cJSON *errors = cJSON_GetObjectItemCaseSensitive(dbv0_0_39_user_infoJSON, "errors");
    if (errors) { 
    ...
    // dbv0_0_39_user_info->warnings
    cJSON *warnings = cJSON_GetObjectItemCaseSensitive(dbv0_0_39_user_infoJSON, "warnings");
    if (warnings) { 
    ...
    // dbv0_0_39_user_info->users
    cJSON *users = cJSON_GetObjectItemCaseSensitive(dbv0_0_39_user_infoJSON, "users");
    if (users) { 
    ...
    dbv0_0_39_user_info_local_var = dbv0_0_39_user_info_create (
