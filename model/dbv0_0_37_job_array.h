/*
 * dbv0_0_37_job_array.h
 *
 * Array properties (optional)
 */

#ifndef _dbv0_0_37_job_array_H_
#define _dbv0_0_37_job_array_H_
...
typedef struct dbv0_0_37_job_array_t dbv0_0_37_job_array_t;

#include "dbv0_0_37_job_array_limits.h"



typedef struct dbv0_0_37_job_array_t {
    int job_id; //numeric
    struct dbv0_0_37_job_array_limits_t *limits; //model
    char *task; // string
    int task_id; //numeric

} dbv0_0_37_job_array_t;
