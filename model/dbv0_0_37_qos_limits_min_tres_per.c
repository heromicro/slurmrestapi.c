...
dbv0_0_37_qos_limits_min_tres_per_t *dbv0_0_37_qos_limits_min_tres_per_create(
    ...
    dbv0_0_37_qos_limits_min_tres_per_t *dbv0_0_37_qos_limits_min_tres_per_local_var = malloc(sizeof(dbv0_0_37_qos_limits_min_tres_per_t));
    if (!dbv0_0_37_qos_limits_min_tres_per_local_var) {
        return NULL;
    }
    dbv0_0_37_qos_limits_min_tres_per_local_var->job = job;

    return dbv0_0_37_qos_limits_min_tres_per_local_var;
}


void dbv0_0_37_qos_limits_min_tres_per_free(dbv0_0_37_qos_limits_min_tres_per_t *dbv0_0_37_qos_limits_min_tres_per) {
    if(NULL == dbv0_0_37_qos_limits_min_tres_per){
        return ;
    }
    listEntry_t *listEntry;
    if (dbv0_0_37_qos_limits_min_tres_per->job) {
        list_ForEach(listEntry, dbv0_0_37_qos_limits_min_tres_per->job) {
            dbv0_0_37_tres_list_inner_free(listEntry->data);
        }
        list_freeList(dbv0_0_37_qos_limits_min_tres_per->job);
        dbv0_0_37_qos_limits_min_tres_per->job = NULL;
    }
    free(dbv0_0_37_qos_limits_min_tres_per);
}
...
cJSON *dbv0_0_37_qos_limits_min_tres_per_convertToJSON(dbv0_0_37_qos_limits_min_tres_per_t *dbv0_0_37_qos_limits_min_tres_per) {
    ...
    // dbv0_0_37_qos_limits_min_tres_per->job
    if(dbv0_0_37_qos_limits_min_tres_per->job) {
    ...
    if (dbv0_0_37_qos_limits_min_tres_per->job) {
    list_ForEach(jobListEntry, dbv0_0_37_qos_limits_min_tres_per->job) {
...
dbv0_0_37_qos_limits_min_tres_per_t *dbv0_0_37_qos_limits_min_tres_per_parseFromJSON(cJSON *dbv0_0_37_qos_limits_min_tres_perJSON){
    ...
    dbv0_0_37_qos_limits_min_tres_per_t *dbv0_0_37_qos_limits_min_tres_per_local_var = NULL;

    // define the local list for dbv0_0_37_qos_limits_min_tres_per->job
    list_t *jobList = NULL;

    // dbv0_0_37_qos_limits_min_tres_per->job
    cJSON *job = cJSON_GetObjectItemCaseSensitive(dbv0_0_37_qos_limits_min_tres_perJSON, "job");
    if (job) { 
    ...
    dbv0_0_37_qos_limits_min_tres_per_local_var = dbv0_0_37_qos_limits_min_tres_per_create (
        job ? jobList : NULL
        );
