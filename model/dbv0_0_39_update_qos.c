...
#include <string.h>
#include <stdio.h>
#include "dbv0_0_39_update_qos.h"
...
dbv0_0_39_update_qos_t *dbv0_0_39_update_qos_create(
    ...
    dbv0_0_39_update_qos_t *dbv0_0_39_update_qos_local_var = malloc(sizeof(dbv0_0_39_update_qos_t));
    if (!dbv0_0_39_update_qos_local_var) {
        return NULL;
    }
    dbv0_0_39_update_qos_local_var->qos = qos;

    return dbv0_0_39_update_qos_local_var;
}


void dbv0_0_39_update_qos_free(dbv0_0_39_update_qos_t *dbv0_0_39_update_qos) {
    if(NULL == dbv0_0_39_update_qos){
        return ;
    }
    listEntry_t *listEntry;
    if (dbv0_0_39_update_qos->qos) {
        list_ForEach(listEntry, dbv0_0_39_update_qos->qos) {
            v0_0_39_qos_free(listEntry->data);
        }
        list_freeList(dbv0_0_39_update_qos->qos);
        dbv0_0_39_update_qos->qos = NULL;
    }
    free(dbv0_0_39_update_qos);
}

cJSON *dbv0_0_39_update_qos_convertToJSON(dbv0_0_39_update_qos_t *dbv0_0_39_update_qos) {
    cJSON *item = cJSON_CreateObject();

    // dbv0_0_39_update_qos->qos
    if(dbv0_0_39_update_qos->qos) {
    ...
    if (dbv0_0_39_update_qos->qos) {
    list_ForEach(qosListEntry, dbv0_0_39_update_qos->qos) {
...
dbv0_0_39_update_qos_t *dbv0_0_39_update_qos_parseFromJSON(cJSON *dbv0_0_39_update_qosJSON){
    ...
    dbv0_0_39_update_qos_t *dbv0_0_39_update_qos_local_var = NULL;

    // define the local list for dbv0_0_39_update_qos->qos
    list_t *qosList = NULL;

    // dbv0_0_39_update_qos->qos
    cJSON *qos = cJSON_GetObjectItemCaseSensitive(dbv0_0_39_update_qosJSON, "qos");
    if (qos) { 
    ...
    dbv0_0_39_update_qos_local_var = dbv0_0_39_update_qos_create (
        qos ? qosList : NULL
        );
